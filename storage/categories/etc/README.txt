...
The files config section within brain -> files -> aiml supports multiple directories. 
In Yaml this is done as follows
...
Using option 2 means that any changes to the core bot in github can be picked 
up without overwritting any grammar that you create yourself